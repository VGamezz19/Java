            ...
            switch (opcio) {
                ...
                case 3:
                    for (int i = 0; i < clinicActual.getComptaElements(); i++) {
                        ...
                        if (clinicActual.getElements()[i] instanceof Enfermera && tipusElement == 2) {
                            clinicActual.getElements()[i].showElement();
                        }
                        if (clinicActual.getElements()[i] instanceof Paciente && tipusElement == 3) {
                            clinicActual.getElements()[i].showElement();
                        }
                    }
                    break;
    ...
    public static void menuDepartments() {
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 5:
                    for (int i = 0; i < clinicActual.getComptaElements(); i++) {
                        if (clinicActual.getElements()[i] instanceof Departamento) {
                            clinicActual.getElements()[i].showElement();
                        }
